...
class client_hello(tls1_3.tls_handshake.HandshakeMessage):
    ...
    def __init__(self, cipher_suites: list[tls1_3.tls_constants.CipherSuites], extensions: list[tls1_3.tls_extensions.ExtensionMessage]):
...
def send_client_hello(sock: socket.socket, state):
    ...
    handshake_message = tls1_3.tls_handshake.Handshake(
        client_hello_message)
    tls_plaintext = tls1_3.tls_plaintext.TLSPlaintext(
